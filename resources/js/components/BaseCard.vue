    ...
    <div class="bg-white mx-auto max-w-sm shadow-lg rounded-lg overflow-hidden mb-4">
        <div class="sm:flex sm:items-center px-6 py-4">
            <div class="text-center sm:text-left sm:flex-grow">
                <div class="mb-1">
                    <a :href="href" class="text-black no-underline flex items-center">
                        <svg class="block w-8" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 331.533 331.533" style="enable-background:new 0 0 331.533 331.533;" xml:space="preserve">
                        ...
                        <div class="ml-4">
                            <p class="text-xl leading-tight" v-text="title"></p>
                            <p class="text-sm leading-tight text-grey-dark" v-text="subtitle"></p>
                        </div>
                    </a>
                </div>
            </div>
